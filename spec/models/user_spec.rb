...
describe User do
  ...
  describe "remember token" do
    before { @user.save }
    # It applies the subsequent test to the given attribute rather than the subject
  ...
  describe "microposts associations" do
    ...
    # The "let bang" method makes sure @user.microposts collection is not empty
    ...
    it "should have the right microposts in the right order" do
      # The posts should be ordered newest first
  ...
  describe "following" do
    ...
    describe "followed user" do
      # We switch subjects from @user to other_user
      subject { other_user }
